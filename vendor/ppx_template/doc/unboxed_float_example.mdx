# ppx_template unboxed float example
...
<!-- $MDX file=../example/import.ml,part=rebind -->
```ocaml
open! Core
...
<!-- $MDX file=../example/import.ml,part=custom-intf -->
```ocaml
...
<!-- $MDX file=../example/each_binding.mli,part=float -->
```ocaml
[%%template:
...
<!-- $MDX file=../example/each_binding.ml,part=float -->
```ocaml
[%%template
[@@@kind.default k = (value, float64)]
...
<!-- $MDX file=../example/separate_submodules.mli,part=arity1 -->
```ocaml
module type S1 = sig
  type t : any
...
<!-- $MDX file=../example/separate_submodules.ml,part=arity1 -->
```ocaml
module type S1 = sig
  type t : any
...
<!-- $MDX file=../example/separate_submodules.mli,part=arity0 -->
```ocaml
[%%template:
[@@@kind.default k = (value, float64)]
...
<!-- $MDX file=../example/separate_submodules.mli,part=arity0-of-arity1 -->
```ocaml
[%%template:
[@@@kind.default k = (value, float64)]
...
<!-- $MDX file=../example/separate_submodules.ml,part=arity0 -->
```ocaml
[%%template
[@@@kind.default k = (value, float64)]
...
<!-- $MDX file=../example/separate_submodules.ml,part=arity0-of-arity1 -->
```ocaml
type module0 = ((module S0 with type t = (float[@kind k]))[@kind k])
