...
let opaque_const x = Bonsai_proc.read (Bonsai_proc.Var.value (Bonsai_proc.Var.create x))
let opaque_const_value x = Bonsai_proc.Var.value (Bonsai_proc.Var.create x)
