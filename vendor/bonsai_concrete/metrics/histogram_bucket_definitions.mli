...
(** Various timings have different distributions:
    ...
    - A lot of stabilizations take no time, but most are somewhere between 5us and 10ms
    ...
    The timings we receive will always be rounded to the nearest 5us or 100us, depending
    on whether our app's headers have enabled cross-origin isolation. *)
