...
[`Atomic` module]: https://ocaml-docs/portable_kernel/Portable_kernel/Atomic/index.html
...
[`Parallel.Sequence.t`]: https://ocaml-docs/parallel_sequence/Parallel_sequence/index.html
