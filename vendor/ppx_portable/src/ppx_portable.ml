...
(* Hack: ppxlib inserts extra binds for ppx-generated code. E.g. if a ppx
   generates:
   ...
   This function checks whether the trailing bindings are suitable for
   being ignored, because they were plausibly generated by ppxlib in this way.
*)
